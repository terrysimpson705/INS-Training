...
const lessons=[
  {
    ...
    "q": [
      ...
      [
        ...
        "An INS black polo with any footwear."
      ],
      1,
      "The uniform includes the approved black INS shirt, black pants or knee-length black shorts, and closed-toe black shoes."
    ]
  },
  {
    "m": 4,
    ...
    "q": [
      ...
      [
        ...
        "Do not report to work; notify your manager as soon as possible."
      ],
      2,
      "Promptly notify your manager if illness prevents you from working."
    ]
  },
  {
    "m": 4,
    ...
    "q": [
      "Which response demonstrates professional telephone service?",
      [
        "“Good morning, INS Market. How can I help you?”",
        "“Yeah? Make it quick.”",
        "Answer while continuing a personal conversation."
      ],
      0,
      "Identify the store, use a courteous greeting and give the caller your attention."
    ]
  },
  {
    "m": 4,
  ...
  },
  {
    ...
    "q": [
      "You are helping someone when another customer enters. What should you do?",
      [
        "Wait until your current transaction is finished, regardless of time.",
        "Ignore the arrival unless they ask for help.",
        "Acknowledge them within one minute with a greeting, nod or “I’ll be with you shortly.”"
      ],
      2,
      "Being busy does not remove the acknowledgment standard. A brief greeting helps the new arrival feel welcome."
    ]
  },
  {
    "m": 4,
    ...
    "q": [
      "A customer is unsure which snack to choose. Which question best helps you understand their needs?",
      [
        "“What kind of snack do you have in mind?”",
        "“You want this one, right?”",
        "“Are you buying anything or not?”"
      ],
      0,
      "An open-ended question invites useful information rather than pushing a predetermined answer."
    ]
  },
  {
    "m": 4,
    ...
    "q": [
      "A customer buys chips. Which approach best follows Step 3?",
      [
        "Insist they buy another item before you ring up the chips.",
        "Offer a drink or a relevant current promotion.",
        "Mention an expired offer because it sounds attractive."
      ],
      1,
      "Make a relevant, accurate suggestion that supports the customer’s purchase."
    ]
  },
  {
    "m": 4,
    ...
    "q": [
      "A queue is growing. Which action still meets Step 4?",
      [
        "Leave the drawer open between customers to save time.",
        "Skip scanning a low-priced item.",
        "Scan every item correctly, close the drawer after the transaction and offer a receipt."
      ],
      2,
      "Speed does not replace accurate registration, cash-drawer control or the receipt offer."
    ]
  },
  {
    "m": 4,
    ...
    "q": [
      "Which closing best meets Step 5?",
      [
        "“Thank you for coming in. Hope to see you again soon.”",
        "Say nothing and immediately look at your phone.",
        "“Next!” before the customer has finished."
      ],
      0,
      "A sincere thank-you and invitation to return complete the five sales standards."
    ]
  },
  {
    "m": 4,
    ...
    "q": [
      "A customer begins explaining a frustrating experience. What is the best first response?",
      [
        "Interrupt to explain why the store cannot be wrong.",
        "Listen without interrupting and acknowledge their concern.",
        "Match their tone so they know you are serious."
      ],
      1,
      "Listening and empathy help identify the issue and de-escalate the interaction."
    ]
  },
  {
    "m": 4,
    ...
    "q": [
      ...
      [
        "“That is your problem. The register is always right.”",
        "“I will give you whatever refund you want without checking.”",
        "“I’m sorry for the frustration. Let’s check what happened and work through the options under our policy.”"
      ],
      2,
      "Acknowledge the experience, investigate calmly and stay within policy rather than arguing or promising an unsupported remedy."
    ]
  },
  {
    "m": 4,
...
const quiz=[
  [
    "Which footwear forms part of the standard uniform?",
    [
      "Any shoes if they are clean.",
  ...
  [
    ...
    [
      "Report to work and say nothing.",
      "Wait for your manager to notice your absence.",
  ...
  [
    ...
    [
      "Only after they approach the register.",
      "Within one minute.",
      "Within five minutes."
    ],
    1,
  ...
  [
    ...
    [
      "“You want the cheapest one, correct?”",
      "“You do not need help, right?”",
      "“What do you have in mind?”"
    ],
    2,
    "Open-ended questions help you listen and guide the customer appropriately."
  ],
  [
    "What makes an add-on suggestion appropriate?",
    [
      "It complements the purchase or highlights a relevant current offer.",
      "It forces the customer to spend more.",
  ...
  [
    ...
    [
      "Offer receipts only when asked.",
      "Scan items correctly, keep the drawer closed before and after, and offer every customer a receipt.",
      "Leave the cash drawer open until the queue clears."
    ],
    1,
    "Correct registration, drawer control and the receipt offer are all part of Step 4."
  ],
  [
    "What is Step 5 of the sales standards?",
    [
      "Begin restocking without acknowledging the customer.",
